...
**관련 문서:** [02 — 시트 딥링크·미리보기](02_시트딥링크미리보기.md) · [03 — 공개 몰·파트너스 링크](03_공개몰파트너스링크.md) · [04 — 관리자 UI·SQLite·env](04_백오피스UI환경SQLite.md)
...
`app/admin/ops/channels/roster/` 아래에 **한 채널당 Python 모듈 하나**를 둡니다. 파일명은 `channel_id`와 같을 필요는 없고, 현재 운영 채널은 `roster/golf.py`(102)·`roster/tennis.py`(103)·`roster/shopping.py`(104) 로 정의되어 있습니다.
...
```bash
.venv/bin/python scripts/seed_influencers_from_roster.py 105 106
```
